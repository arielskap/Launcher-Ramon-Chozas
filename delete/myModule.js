exports.modules = {
  ...
  obtieneVersionDelServidor(callback) {
    let data_ws = '';
    const options = {
  ...
  actualizaSistema(dependencias) {
    ...
    const array_dependencies = dependencias.split('&');

    const prueba = 'C:/Windows/system32/cmd.exe /k cd C:/chozassa_v2 & curl www.dynamicdoc.com.ar/node/build/upgrade/chozassa_v2.exe -o C:/chozassa_v2/chozassa_v2.exe & ' +
